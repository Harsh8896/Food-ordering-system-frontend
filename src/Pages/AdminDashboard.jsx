...
const AdminDashboard = () => {
    ...
    const cardData = [
        ...
        { title: "Today's Earnings (85%)", key: 'today_sales', color: '#0ea5e9', icon: <FaCoins />, isCash: true },
{ title: "Weekly Earnings (85%)", key: 'week_sales', color: '#ec4899', icon: <FaCalendarWeek />, isCash: true },
{ title: "Monthly Earnings (85%)", key: 'month_sales', color: '#1e293b', icon: <FaCalendarAlt />, isCash: true },
{ title: "Yearly Earnings (85%)", key: 'year_sales', color: '#059669', icon: <FaCalendar />, isCash: true },
